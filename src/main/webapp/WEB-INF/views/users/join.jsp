...
<div class="container-fluid my-5">
	<div class="row col-md-8 offset-md-2">
		...
		<div class="mb-3">
		  ...
		  <input type="password" class="form-control" name="password" id="formGroupExampleInput2" placeholder="Another input placeholder"><br>
		  ...
		  <a class="btn btn-danger" href="join">취소</a>
		  </div>
		</form>
	</div>
</div>
